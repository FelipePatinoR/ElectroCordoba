    ...
    <section class="seccion-perfil-usuario">
        ...
        <div class="perfil-usuario-body">
            <div class="perfil-usuario-bio">
                ...
                <label for="">Descripción de usuario:</label>
...
<div class="mis-redes" style="display: block;position: fixed;bottom: 1rem;left: 1rem; opacity: 0.5; z-index: 1000;">
    <p style="font-size: .75rem;">ElectroCordoba</p>
    <div>
        <a target="_blank" href="https://www.facebook.com/jesusdavid.erazo/"><i class="fab fa-facebook-square"></i></a>
        <a target="_blank" href="https://www.instagram.com/jesusdaviderazo/"><i class="fab fa-instagram"></i></a>
        <a target="_blank" href="https://www.youtube.com/channel/UCpYMZEIxbDsj2zq5Kqa1amQ"><i class="fab fa-youtube"></i></a>
    </div>
</div>
