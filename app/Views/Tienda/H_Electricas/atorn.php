...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <h5 class="card-header">ATORNILLADOR PARA DRYWALL 520W</h5>
                <div class="bg-image hover-overlay ripple text-center" data-mdb-ripple-color="dark">
                    <img src="<?php echo base_url() ?>img/Herramientas_Electricas/Atornilladores/atornillador-para-drywall-520w.jpg"
                        class="img-fluid" />
                    <br>
        ...
        <div class="col-md-4">
            <div class="card">
                <h5 class="card-header">ATORNILLADOR DE IMPACTO VVR 6.35MM MAKITA</h5>
                <div class="bg-image hover-overlay ripple text-center" data-mdb-ripple-color="dark">
                    <img src="<?php echo base_url() ?>img/Herramientas_Electricas/Atornilladores/atornillador-de-impacto-vvr-635mm-makita.jpg"
                        class="img-fluid" />
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="container-fluid">
                    <div class="row text-start">
                        <h5 class="modal-title">ATORNILLADOR DE IMPACTO VVR 6.35MM MAKITA</h5>
                    </div>
                    <div class="row text-start">
                        <label>Referencia:</label>
                    </div>
